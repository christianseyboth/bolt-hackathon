...
export const blog = {
  ...
  // Use a remote image URL instead of the local thumbnail
  image: 'https://images.unsplash.com/photo-1504384308090-c894fd248f53?q=80&w=3540&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
};
