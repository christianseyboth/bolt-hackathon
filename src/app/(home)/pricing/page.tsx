        ...
        <section className="py-20 sm:py-40">
          <Container className="max-w-4xl mx-auto text-center">
            ...
            <Subheading className="max-w-2xl mx-auto">
              Protect your business from email threats with plans that scale from individual
              professionals to enterprise teams. All plans include AI-powered threat detection,
              real-time protection, and zero-storage privacy.
            </Subheading>
          </Container>
        </section>
