  ...
  return (
    <main className="relative min-h-screen bg-neutral-950">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-32 left-20 w-24 h-24 bg-blue-500/8 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '2s' }} />
        ...
        <section className="py-20 sm:py-40">
          <Container className="max-w-4xl mx-auto text-center">
            ...
            <Subheading className="max-w-2xl mx-auto">
              Whether you need technical support, have enterprise sales questions, or want to learn
              more about protecting your organization from email threats - our security experts are
              here to help.
            </Subheading>
          </Container>
        </section>
        ...
        <section className="py-16">
          <Container className="max-w-4xl mx-auto text-center">
            <div className="bg-neutral-900/30 border border-neutral-800 rounded-xl p-8">
              <h3 className="text-xl font-semibold mb-4">Our Response Time Guarantee</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                <div>
                  <div className="text-2xl font-bold text-emerald-400 mb-2">2 hours</div>
                ...
                <div>
                  <div className="text-2xl font-bold text-purple-400 mb-2">15 min</div>
                  <p className="text-neutral-400">Emergency support (Enterprise)</p>
                </div>
              </div>
