                    ...
                    <div className='space-y-6 text-center'>
                        ...
                        <div className='bg-red-900/30 border border-red-800 text-red-400 px-4 py-3 rounded-md text-sm text-left'>
                            ...
                            <div className='space-y-1 text-xs'>
                                ...
                                <div><strong>Description:</strong> {decodeURIComponent(errorDescription)}</div>
                            </div>
                        </div>
                        ...
                        {errorDescription.includes('Database error saving new user') && (
                            <div className='bg-blue-900/30 border border-blue-800 text-blue-400 px-4 py-3 rounded-md text-sm text-left'>
                                ...
                                <div className='space-y-2 text-xs'>
                                    <p>This error typically occurs when the database schema isn't properly configured for new user registration.</p>
                                    <p>The administrator needs to set up the user profiles table and triggers in Supabase.</p>
                                </div>
                            </div>
                        )}
                        ...
                        <div className='space-y-3'>
                            ...
                            <Link href='/'>
                                <Button variant='outline' className='w-full bg-neutral-800 hover:bg-neutral-700 text-white border-neutral-700'>
                                    Go Home
                                </Button>
                            </Link>
                        </div>
