...
const toastVariants = {
    ...
    destructive: 'destructive group border-red-500 bg-red-600 text-neutral-50',
    success: 'success group border-emerald-500 bg-emerald-600 text-neutral-50',
};
...
>(({ className, ...props }, ref) => (
    <ToastPrimitives.Close
        ref={ref}
        className={cn(
            'absolute right-2 top-2 rounded-md p-1 text-neutral-400 opacity-0 transition-opacity hover:text-neutral-200 focus:opacity-100 focus:outline-none focus:ring-2 group-hover:opacity-100',
            className
        )}
        toast-close=''
        {...props}
