      ...
      <Container className="text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-neutral-400 mb-8 max-w-2xl mx-auto">
            Join 10,000+ businesses using SecPilot's AI-powered email security to prevent phishing,
            malware, and ransomware attacks. 99.9% accuracy, zero-storage privacy, and seamless
            integration with Gmail, Outlook, and Office 365. Start your free trial today.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
            <div className="border border-neutral-800 rounded-lg p-6 bg-neutral-900/50">
              ...
              <div className="text-3xl font-bold mb-2">$19<span className="text-sm text-neutral-400">/mo</span></div>
              <p className="text-neutral-400 text-sm">Perfect for individual professionals</p>
            </div>
            ...
            <div className="border border-blue-500 rounded-lg p-6 bg-blue-500/5 relative">
              ...
              <div className="text-3xl font-bold mb-2">$49<span className="text-sm text-neutral-400">/mo</span></div>
            ...
            <div className="border border-neutral-800 rounded-lg p-6 bg-neutral-900/50">
              ...
              <div className="text-3xl font-bold mb-2">$99<span className="text-sm text-neutral-400">/mo</span></div>
