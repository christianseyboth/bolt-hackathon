...
export function TopAttackTargetsChart({ topTargets }: any) {
    const [activeIndex, setActiveIndex] = React.useState(0);

    const chartData = (topTargets ?? []).map((row: any) => ({
        name: row.email,
        value: row.attack_count,
    }));
        ...
        <Card className='border-neutral-800 bg-neutral-900'>
            ...
            <CardContent>
                <Tabs defaultValue='pie'>
                    ...
                    <TabsContent value='bar' className='h-[600px] relative'>
                        <ResponsiveContainer width='100%' height='100%'>
                            <BarChart
                                data={chartData}
                                layout='vertical'
