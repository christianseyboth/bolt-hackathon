            ...
            {accountData.hasActiveSubscription && (
              <div className="pt-2 border-t border-neutral-700">
                ...
                <p className="text-xs text-neutral-400 mt-1">
                  You have an active subscription. Canceling will stop future billing.
                </p>
              </div>
            )}
          </div>
            ...
            <DialogContent className="bg-neutral-900 border-neutral-800">
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-neutral-400">
                  Your data will be exported as a JSON file. Sensitive information like API key secrets are excluded for security.
                </p>
              </div>
              <DialogFooter>
        ...
        <AlertDialogContent className="bg-neutral-900 border-neutral-800">
              ...
              {accountData?.hasActiveSubscription && (
                <span className="block bg-orange-950/20 border border-orange-900/30 p-3 rounded">
                  <span className="text-orange-400 text-sm font-medium">
                    ⚠️ You have an active subscription that will be cancelled immediately.
                  </span>
                </span>
              )}
            </AlertDialogDescription>
          ...
          <div className="py-4">
            <Label htmlFor="confirmation" className="text-sm font-medium">
              Type <code className="bg-neutral-800 px-1 rounded text-red-400">DELETE</code> to confirm:
            </Label>
            <Input
              id="confirmation"
