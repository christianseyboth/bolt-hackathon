          ...
          <div className="flex space-x-2">
            ...
            <Tabs defaultValue="all" className="inline-flex h-9">
              <TabsList className="grid grid-cols-3 h-9">
                ...
                <TabsTrigger value="clean" className="text-xs">Clean</TabsTrigger>
              </TabsList>
            </Tabs>
          </div>
        </div>
        ...
        {filteredEmails.length > 0 && (
          <div className="flex justify-between items-center mt-4">
            <div className="text-sm text-neutral-400">
              Showing <span className="font-medium text-neutral-300">{filteredEmails.length}</span> of <span className="font-medium text-neutral-300">{mockEmails.length}</span> emails
            </div>
            <div className="flex space-x-2">
              <Button variant="outline" size="sm" disabled className="text-neutral-300 border-neutral-700">
                Previous
              </Button>
              <Button variant="outline" size="sm" className="text-neutral-300 border-neutral-700">
                Next
