...
import { IconMail, IconCopy, IconCheck, IconArrowRight, IconInfoCircle } from '@tabler/icons-react';
                            ...
                            <div className='flex items-start gap-3'>
                                ...
                                <div>
                                    ...
                                    <p className='text-sm text-neutral-300'>
                                        Forward suspicious emails to start analysis. We'll scan them
                                        for threats and provide detailed reports.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='space-y-3'>
                            <div>
                                ...
                                <p className='text-xs text-neutral-400 mt-1'>
                                    Set up a forwarding rule in your email client to send suspicious
                                    emails here
                                </p>
                            </div>
                            ...
                            <div className='flex gap-2'>
                                ...
                                <Button variant='outline'>Test Setup</Button>
                            </div>
                        </div>
                    </div>
                ) : (
