...
const SCORE_RANGES = {
    ...
    GOOD: {
        ...
        recommendation:
            'Great job! Monitor for any emerging threats and maintain current practices.',
        urgency: 'low' as const,
    },
    MEDIUM: {
        min: 55,
        ...
        recommendation:
            'Review your email filters and security policies. Some threats are getting through.',
    ...
    LOW: {
        ...
        recommendation:
            'Take immediate action to improve your email security settings and policies.',
    ...
    POOR: {
        ...
        recommendation:
            'Urgent action required! Multiple high-risk threats detected. Review all security settings immediately.',
                    ...
                    <div className='flex flex-col items-center justify-center pt-6 pb-8 text-neutral-400'>
                        ...
                        <div className='mt-4 p-3 bg-neutral-800/50 rounded-lg text-xs text-center'>
                            ...
                            <div className='text-neutral-400 text-[10px]'>
                                A 0-100 rating of your email security health based on threat
                                detection, risk levels, and false positives over the last 30 days.
                            </div>
                        </div>
                    </div>
                </CardContent>
                    ...
                    <span className='ml-2 group relative'>
                        ...
                        <div className='absolute left-6 top-0 z-10 hidden group-hover:block bg-neutral-800 text-xs text-neutral-100 p-3 rounded shadow-lg w-[320px] border border-neutral-700'>
                            ...
                            <div className='text-[10px] font-mono bg-neutral-900 p-2 rounded'>
                                100 - (avg_risk × 0.5) - (false_pos × 2) - (critical × 5) - (high ×
                                2) - (threats × 1.5)
                            </div>
                        </div>
                    </span>
                    ...
                    <div className='w-full grid grid-cols-2 gap-2 mb-4 text-xs'>
                        ...
                        <div className='flex justify-between p-2 bg-neutral-800/20 rounded'>
                            ...
                            <span className='text-neutral-300'>
                                {scoreData.avg_risk_score?.toFixed(1) || 0}
                            </span>
                        </div>
                    </div>
