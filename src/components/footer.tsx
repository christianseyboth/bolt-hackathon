...
import { IconMail, IconShieldCheck, IconBolt, IconBrandTwitter, IconBrandLinkedin, IconBrandGithub } from "@tabler/icons-react";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-neutral-400 text-sm leading-relaxed mb-6 max-w-md">
                Advanced AI-powered email security that protects your organization from sophisticated threats.
                Real-time detection, automated response, and comprehensive compliance.
              </p>
        ...
        <div className="border-t border-neutral-800 py-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            <div className="mb-4 lg:mb-0">
              <h3 className="text-white font-semibold text-sm mb-2">Stay updated on security threats</h3>
              <p className="text-neutral-400 text-sm">Get weekly insights on email security trends and threat intelligence.</p>
            </div>
