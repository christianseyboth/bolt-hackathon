      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <Subheading className="text-left text-neutral-400 mt-4">
            Ready to protect your organization from email threats? Our cybersecurity experts
            are standing by to help you choose the right email security solution and get
            started with advanced threat protection.
          </Subheading>
        </div>
        ...
        <div className="space-y-6">
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-500 mt-1">Typical response within 2 hours</p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-500 mt-1">Available for Team & Enterprise plans</p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-neutral-400">Monday - Friday, 9AM - 6PM EST</p>
              <p className="text-xs text-neutral-500 mt-1">24/7 emergency support for Enterprise</p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-500 mt-1">Serving customers globally</p>
            </div>
          </div>
        </div>
        ...
        <div className="pt-6 border-t border-neutral-800">
          <p className="text-xs text-neutral-500 mb-3">Trusted by security professionals</p>
      ...
      <div className="flex flex-col items-start gap-6 max-w-xl w-full mx-auto bg-gradient-to-b from-neutral-900/50 to-neutral-950/50 p-8 lg:p-10 rounded-2xl relative overflow-hidden border border-neutral-800 backdrop-blur-sm">
        ...
        <div className="w-full relative z-20">
          ...
          <p className="text-sm text-neutral-400 mb-6">
            Tell us about your email security needs and we'll get back to you within 24 hours.
          </p>
        </div>
        ...
        <div className="mb-4 w-full relative z-20">
          <label className="text-neutral-300 text-sm font-medium mb-2 inline-block" htmlFor="subject">
            Inquiry Type
          </label>
          <select
            id="subject"
