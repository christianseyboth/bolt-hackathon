                    ...
                    return (
                        <Card
                            ...
                            className={cn(
                                ...
                                isPopular &&
                                    'border-emerald-500/50 shadow-emerald-500/10 shadow-2xl scale-105 bg-emerald-500/5'
                            )}
                        >
                            {isPopular && (
                ...
                <Card className='max-w-2xl mx-auto border-neutral-800 bg-neutral-900/30'>
                    <CardContent className='p-8'>
                        ...
                        <p className='text-neutral-400 mb-6'>
                            Custom pricing for large organizations with advanced security
                            requirements
                        </p>
