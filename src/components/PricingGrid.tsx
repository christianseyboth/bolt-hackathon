    ...
    const tiers = [
        {
            ...
            features: [
                ...
                <span key='access'>
                    Access to{' '}
                    <CustomLink href='https://ui.aceternity.com'>Aceternity UI</CustomLink>
                </span>,
            ],
            onClick: () => {
        ...
        },
        {
            ...
            features: [
                ...
                <span key='access'>
                    Support for <CustomLink href='https://algochurn.com'>Slack</CustomLink> and{' '}
                ...
                {tiers.map((tier, index) => (
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className='text-sm text-neutral-4000 mt-4'>{tier.description}</p>
                            <div className='mt-4'>
